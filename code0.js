...
};gdjs.Clicker_32sceneCode.asyncCallback13439292 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Clicker_32sceneCode.asyncCallback13439292(runtimeScene, asyncObjectsList)));
}
}
...
}{gdjs.evtTools.storage.writeStringInJSONFile("clicker", "ultimateupgradebought?", runtimeScene.getGame().getVariables().getFromIndex(5).getAsString());
}}
...
}{gdjs.evtTools.storage.readStringFromJSONFile("clicker", "ultimateupgradebought?", runtimeScene, runtimeScene.getGame().getVariables().getFromIndex(5));
}}
