...
gdjs.SHOPCode.asyncCallback11787628 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.SHOPCode.asyncCallback11787628(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getGame().getVariables().getFromIndex(1).getAsNumber() >= 250000);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("ULTIMATE_UPGRADE"), gdjs.SHOPCode.GDULTIMATE_9595UPGRADEObjects1);
{for(var i = 0, len = gdjs.SHOPCode.GDULTIMATE_9595UPGRADEObjects1.length ;i < len;++i) {
    gdjs.SHOPCode.GDULTIMATE_9595UPGRADEObjects1[i].deleteFromScene(runtimeScene);
}
}}
